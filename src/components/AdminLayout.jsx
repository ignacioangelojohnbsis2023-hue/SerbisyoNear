...
export default function AdminLayout({ title, topRight, headerEyebrow = "Admin", headerSubtitle, children }) {
  ...
  return (
    <div className="min-h-screen bg-cream-100">
          ...
          <div className="sticky top-0 z-30 bg-cream-100 px-5 pt-5 pb-3 sm:px-6 lg:px-9 lg:bg-transparent">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <AccountMenu user={currentUser} role="Admin" onHelpSupport={() => setSupportOpen(true)} />
              </div>
            </div>
          </div>
      ...
      <SupportChatbot open={supportOpen} onClose={() => setSupportOpen(false)} role="Admin" />
    </div>
  );
}